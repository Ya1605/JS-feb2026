...
const allUser = users[i];
document.write(`<div>
   <h3> ${allUser.name} - ${allUser.age} - ${allUser.status}</h3>
...
//- За допомогою циклу for і document.write()
 ...
 const allUser = users[i];
 document.write(`<div>
    <h3> ${allUser.name} - ${allUser.age} - ${i}</h3>
...
for (let setUser of setUsers){
if(setUser.status == true){
console.log(setUser);
}
}
for (let setUser of setUsers){
if(setUser.status === false){
console.log(setUser);
}
}
